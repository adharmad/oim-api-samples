...
public class ProvisionAccount {
	public static void main(String[] args) throws Exception {
        ...
        SearchCriteria criteria = new SearchCriteria("User Login",
                "BADSHAH", SearchCriteria.Operator.EQUAL);
        ...
        ApplicationInstance ai = aiSvc.findApplicationInstanceByName("prov1");
        ...
        for (FormField f : fields) {
        	if (f.getLabel().equals("itres") || f.getType().equals("DateFieldDlg")) {
        		continue;
        	} else if (f.getLabel().equals("fname")) {
        		parentData.put(f.getName(), u.getFirstName() + "XXXX");
        	} else if (f.getLabel().equals("lname")) {
        		parentData.put(f.getName(), u.getLastName() + "YYYY");
        	}
        }
