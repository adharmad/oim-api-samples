...
public class CreateAppInstanceProvisioningRequest {
	public static void main(String[] args) throws Exception {
        ...
        requestEntity.setEntitySubType("toclean");
        requestEntity.setEntityKey("6"); 
        ...
        //RequestBeneficiaryEntityAttribute attr = new RequestBeneficiaryEntityAttribute("Account Login", "TEST5HAHA", RequestBeneficiaryEntityAttribute.TYPE.String); 
        //attrs.add(attr);
        RequestBeneficiaryEntityAttribute attr = new RequestBeneficiaryEntityAttribute("Password", "Welcome1", RequestBeneficiaryEntityAttribute.TYPE.String);
        attrs.add(attr);
